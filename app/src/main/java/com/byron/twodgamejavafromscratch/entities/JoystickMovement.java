...
public class JoystickMovement extends GameEntity{
    ...
    public JoystickMovement(SurfaceView sv, float centerPositionX, float centerPostitionY, float outerCircleRadius, float innerCircleRadius){
        ...
        outerCirclePaintLine.setColor(Color.GREEN);
